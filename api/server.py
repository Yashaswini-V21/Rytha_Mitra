"""
Rytha Mitra Enterprise API Server
===================================
...
def create_app():
    ...
    def health():
        ...
        all_ok = model_exists and groq_key and sarvam_key
        return {
    ...
    def season_plan():
        ...
        # Header
        header_data = [[
          Paragraph(f"<font color='white' size=18><b>ರೈತ ಮಿತ್ರ · Season Advisory Plan</b></font>", styles['Normal']),
        ...
        story.append(Paragraph(
          "<font size=9 color='#6b7280'>Generated by Rytha Mitra · WitchHunt 2026 · Climate Action Track · ₹0 Stack Cost</font>",
          styles['Normal']))
...
if __name__ == "__main__":
    ...
    print()
    print("  ╔══════════════════════════════════════════╗")
    print("  ║   🌾 Rytha Mitra Enterprise API v1.1    ║")
    print("  ╠══════════════════════════════════════════╣")
